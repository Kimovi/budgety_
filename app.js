...
var budgetController = (function() {
    ...
    return {
        ...
        calculateBudget: function() {
            ...
            // 3. calcuate the percentage of income that we spent 
        ...
        calculatepPercentages : function() {
...
var UIController = (function() {
    ...
    return {
        ...
        clearFields: function() {
            ...
            fieldsArr[0].focus(); // move the focus back to the first input box 
        },
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var updatePercentages = function() {
        ...
        budgetCtrl.calculatepPercentages();
